      ...
      <div className="Left-panel w-1/2  text-white p-12 flex flex-col justify-center">
        <div className="Left-panel-div mb-8">
          ...
          <h1 className="text-5xl font-bold mb-6 leading-tight">
            The Official E-Filing<br />
            System of the Court of<br />
            Appeal
          </h1>
          ...
          <p className="text-xl leading-relaxed opacity-90">
            Only legal practitioners accredited by the<br />
            Nigerian Bar Association (NBA) may use<br />
        ...
        <div className="max-w-md mx-auto w-full">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">
              File appeals, track motions and manage<br />
              case documents securely and efficiently<br />
            ...
            >
              <div className="flex items-center justify-between">
                <div className="text-left">
                  <div className="font-semibold text-lg">Create Lawyer Account</div>
                  <div className="text-sm opacity-75">
                    To have access to the features of this app, you must have an<br />
            ...
            >
              <div className="flex items-center justify-between">
                <div className="text-left">
                  ...
                  <div className="text-sm opacity-75">
                    If you already have an account with us, login to access your<br />
                    dashboard
                  </div>
                </div>
