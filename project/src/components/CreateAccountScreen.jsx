      ...
      <div className=" Left-panel w-2/5  text-white p-12 flex flex-col justify-center">
        <div className=" Left-panel-div mb-8">
          ...
          <p className="text-lg leading-relaxed opacity-90 mb-12">
            Create your official CasePort profile to begin<br />
            filing appeals and legal documents across<br />
        ...
        <div className="max-w-lg mx-auto w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              {errors.fullName && <p className="text-green-900 text-sm mt-1">{errors.fullName}</p>}
            </div>
            ...
            <div className="border-t border-gray-200 pt-6">
              ...
              <p className="text-sm text-gray-500 mt-1">Caps, Number, Character</p>
              {errors.password && <p className="text-red-500 text-sm mt-1">{errors.password}</p>}

              {/* Password strength indicator */}
              <div className="flex space-x-1 mt-2">
                <div className={`h-1 flex-1 rounded ${formData.password.length >= 2 ? 'bg-green-400' : 'bg-gray-200'}`}></div>
                <div className={`h-1 flex-1 rounded ${formData.password.length >= 4 ? 'bg-green-600' : 'bg-gray-200'}`}></div>
                <div className={`h-1 flex-1 rounded ${formData.password.length >= 6 ? 'bg-green-800' : 'bg-gray-200'}`}></div>
                <div className={`h-1 flex-1 rounded ${formData.password.length >= 8 ? 'bg-green-900' : 'bg-gray-200'}`}></div>
              </div>
            </div>
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              By clicking "Register", you agree to our existing terms and<br />
              condition as a practicing lawyer in the Federal Republic of<br />
              Nigeria.
            </p>
